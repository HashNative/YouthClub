 ...
 * @param {String} ctr Name of basic constructor to returns
...
<pre>
function(code, multiMap){
  returns 'jquery-jvectormap-data-'+
         code.toLowerCase()+'-'+
