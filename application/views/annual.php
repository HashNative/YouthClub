...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li>/ view <a href="<?php echo base_url(); ?>" class="btn btn-secondary btn-sm breadcrumb-item">Monthly Report</a></li>
    </ol>
    ...
    <div class="card mb-3">
        <div class="card-header">
            ...
            Annual Transaction - For this year (<a href="<?php echo base_url('reports/annual'); ?>"><?php echo $year; ?></a>)
            ...
            <div class="modal inmodal" id="filterModal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form role="form" action="<?php echo base_url('/reports/annual'); ?>" method="post" id="filterForm">
                            <div class="confirmation-modal-body">
                                <div class="modal-body">
                                    <label>Select Year to filter: </label><input type="month" class="form-control" id="month" name="month" required>
                                </div>
