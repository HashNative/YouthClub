    ...
    <div class="container-fluid">
        ...
        <div class="row wrapper border-bottom white-bg">
            <div class="col-lg-4 navbar-right">
                <a class="minimalize-styl-2 btn btn btn-outline-secondary " href="<?php echo base_url('chit') ?>"><i class="fa fa-eye"></i> Chit History</a>
            </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                        ...
                        <form role="form" action="<?php base_url('chit/edit') ?>" method="post">
                            ...
                            <div class="form-row">
                                <div class="form- col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="chit_no" name="chit_no" placeholder="Chit Number" >
                                </div>
                ...
                <button type="submit" class="btn btn-success">Issue Chit</button>
                </form>
