                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                    <?php foreach ($chit_payment_data as $k => $v): ?>
                                                        <tr>
                                                            <td><?php echo $v['chit_payment_info']['membership_no']; ?></td>
                                                            <td><?php echo $v['chit_payment_info']['full_name']; ?></td>
                                                            <td><?php echo $v['chit_payment_info']['date']; ?></td>
                                                            <td><?php echo $v['chit_payment_info']['chit']; ?></td>
        ...
        <?php }else{ ?>
            <div class="row justify-content-center">
                <div class="col-sm-6 align-item-center">
                    ...
                    <div class="row justify-content-center">
                        <h2><strong>Chit Payment</strong></h2>
                    </div>
                    <div class="row justify-content-center">
                        <a href="<?php echo base_url('payment/create') ?>" class="btn btn-primary btn-md"><i class="fa fa-plus"></i> Get Payment</a>
                    </div>
                </div>
            </div>
        <?php }?>
